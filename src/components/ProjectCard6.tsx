  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-0 justify-between">
        <div className="flex flex-col gap-1">
          ...
          <p style={{color: '#64748b', fontFamily: 'monospace'}} className="text-base">
            Read ERC-20 token data & visualize on-chain Transfer events — no API key required
          </p>
        </div>
        <a href="https://github.com/roybeey0/smart-contract-interaction" target="_blank"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Events', value: '1,538', sub: 'LINK Transfers' },
          { label: 'Blocks', value: '1K', sub: 'Block range scanned' },
          { label: 'Charts', value: '5', sub: 'Dark theme viz' },
          { label: 'RPC', value: 'Free', sub: 'No API key needed' },
        ].map(m => (
      ...
      <div className="flex flex-wrap gap-2 text-sm">
        {['Token Metadata', 'Balance Checker', 'Transfer Events', 'ERC-20 ABI', 'Web3.py', 'Public RPC', 'CLI Interface', 'Interactive Menu', 'No API Key'].map(f => (
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {['Python 3.12', 'Web3.py', 'Pandas', 'Matplotlib', 'Seaborn', 'Ethereum Mainnet'].map(t => (
