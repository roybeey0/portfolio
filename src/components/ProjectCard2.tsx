    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          { label: 'ROUGE-L', value: '0.594' },
          { label: 'Train Loss', value: '1.071' },
        ].map(m => (
      ...
      <div className="flex flex-wrap gap-2 text-sm text-zinc-600">
        <span className="border border-white/5 rounded-md px-2 py-1">CodeT5 Transformer</span>
        <span className="border border-white/5 rounded-md px-2 py-1">Seq2Seq Fine-tuning</span>
        <span className="border border-white/5 rounded-md px-2 py-1">Beam Search Decoding</span>
        <span className="border border-white/5 rounded-md px-2 py-1">CodeSearchNet Dataset</span>
        <span className="border border-white/5 rounded-md px-2 py-1">Gradio Web UI</span>
        <span className="border border-white/5 rounded-md px-2 py-1">50K Training Samples</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-2 flex-wrap">
          <span className="text-zinc-500 text-sm bg-white/[0.03] rounded px-2 py-0.5">Python 3.10</span>
          <span className="text-zinc-500 text-sm bg-white/[0.03] rounded px-2 py-0.5">PyTorch</span>
          <span className="text-zinc-500 text-sm bg-white/[0.03] rounded px-2 py-0.5">HuggingFace</span>
          <span className="text-zinc-500 text-sm bg-white/[0.03] rounded px-2 py-0.5">Gradio</span>
          <span className="text-zinc-500 text-sm bg-white/[0.03] rounded px-2 py-0.5">Kaggle P100</span>
        </div>
      </div>
